...
<graph name="Unnamed Graph">
    ...
    <filter name="bbb_360p_10sec.mp4" index="4" clsid="{B98D13E7-55DB-4385-A33D-09FD1BA26338}">
        <ifilesourcefilter source="bbb_360p_10sec.mp4"/>
    </filter>
    <connect out="bbb_360p_10sec.mp4/Video" in="LAV Video Decoder/Input" outFilterIndex="4" outPinId="Video" outPinName="Video" outPinIndex="0" inFilterIndex="3" inPinId="In" inPinName="Input" inPinIndex="0" direct="true">
    ...
    <connect out="bbb_360p_10sec.mp4/Audio" in="LAV Audio Decoder/Input" outFilterIndex="4" outPinId="Audio" outPinName="Audio" outPinIndex="1" inFilterIndex="2" inPinId="In" inPinName="Input" inPinIndex="0" direct="true">
